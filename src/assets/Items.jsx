...
export function Items(props) {
    return(
            <div className='flex flex-nowrap mx-4  p-3 rounded-xl bg-[#282828] mt-6'>
                 <span>
                  <img src={props?.Source} className='flex me-2 w-24 h-24 rounded-xl'></img>
                 </span>
                 <div className="flex flex-col mt-1 ml-28 mr-2 lg:ml-72">
                 ...
                 <button onClick={"#"} className='order-1'>
                    <FontAwesomeIcon icon={faPlus} onClick={'#'} className='text-white text-sm bg-[#f44336] rounded-xl p-3 mt-12 ml-1' />
                 </button>
            </div>
